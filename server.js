...
app.get('/checkout.html', (req, res) => {
  res.sendFile(path.join(PUBLIC, 'checkout.html'));
});
app.get('/track.html', (req, res) => {
  res.sendFile(path.join(PUBLIC, 'track.html'));
});
app.get('/product.js', (req, res) => {
  res.sendFile(path.join(PUBLIC, 'product.js'));
});
app.get('/store.css', (req, res) => {
  res.sendFile(path.join(PUBLIC, 'store.css'));
});
app.get('/checkout.js', (req, res) => {
  res.sendFile(path.join(PUBLIC, 'checkout.js'));
});
